...
GEMINI_API_KEY = os.getenv("GOOGLE_GEN_AI_API_KEY")
...
async def predict(req: PredictRequest):
    try:
        if req.engine == "dl" and vectorizer:
            ...
            prompt = f"Analyze: {req.text[:800]}. Return ONLY JSON: {{\"prediction\": \"Real News\", \"confidence\": (0.95 to 0.99), \"reason\": \"text\"}}"
            ...
            data["model_used"] = "Gemini 2.5 Flash Lite"
            return data
    except Exception as e:
